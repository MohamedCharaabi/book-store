...
const Home: FC = (props: Props) => {
  ...
  return (
    <div>
      ...
      <div className="h-full w-full flex px-10 mt-2 mb-8">
          ...
          <div className="w-3/4 shadow-md">
            <div className="flex h-full">
              <img
                ...
                alt="author"
                src="https://assets.entrepreneur.com/content/3x2/2000/20170919152836-unnamed.jpeg"
              />
              <div className="flex flex-col justify-start mt-7 ml-4">
                <div>
                  <h5>Benjamin</h5>
                  <h5>20 books</h5>
                  <span className="  top-1/2 left-0 w-full text-yellow-300 ">
                    ✻✻✻✻✻ <span className="text-black">1210 votes</span>
                  </span>
                </div>

                <button className="bg-yellow-500 w-max p-1 text-white rounded mt-3">
                  Check it now
                </button>
              </div>
            </div>
